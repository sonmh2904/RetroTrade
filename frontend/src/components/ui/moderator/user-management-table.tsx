...
export function ModeratorUserManagementTable() {
  ...
  useEffect(() => {
    ...
    const debounceTimer = setTimeout(
      ...
      searchTerm ? 500 : 0
    ); // Only delay if there's a search term, otherwise immediate
      ...
      <CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="relative">
            ...
            >
              <option value="all" className="bg-gray-50 text-gray-900">
                Tất cả loại vấn đề
              </option>
              <option value="complaint" className="bg-gray-50 text-gray-900">
                Có khiếu nại
              </option>
              <option value="report" className="bg-gray-50 text-gray-900">
                Bị báo cáo
              </option>
              <option value="dispute" className="bg-gray-50 text-gray-900">
                Có Khiếu nại
              </option>
              <option value="banned" className="bg-gray-50 text-gray-900">
                Đã bị khóa
              </option>
            </select>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="renter" className="bg-gray-50 text-gray-900">
                Người thuê
              </option>
              <option value="owner" className="bg-gray-50 text-gray-900">
                Chủ sở hữu
              </option>
              <option value="moderator" className="bg-gray-50 text-gray-900">
                Điều hành viên
              </option>
              <option value="admin" className="bg-gray-50 text-gray-900">
                Quản trị viên
              </option>
            </select>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="verified" className="bg-gray-50 text-gray-900">
                Đã xác minh
              </option>
              <option value="pending" className="bg-gray-50 text-gray-900">
                Chờ xác minh
              </option>
              <option value="unverified" className="bg-gray-50 text-gray-900">
                Chưa xác minh
              </option>
            </select>
          </div>
              ...
              {filteredUsers.length === 0 ? (
                    ...
                    <div className="text-gray-600">
                      ...
                      <p className="text-sm">
                        ...
                        issueTypeFilter !== "all"
                          ...
                          : "Hiện tại không có người dùng nào cần xử lý (có khiếu nại, bị báo cáo, Khiếu nạihoặc đã bị khóa)"}
                      </p>
                    </div>
                  </TableCell>
                </TableRow>
                ...
                filteredUsers.map((user) => (
                  <TableRow key={user._id}>
                    ...
                    <TableCell>{getIssueBadges(user.issues)}</TableCell>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <div className="w-16 bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${(user.reputationScore / 5) * 100}%`,
                            }}
                          />
                        </div>
                      </div>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <p className="text-sm text-red-800">
                <strong>Lưu ý:</strong> Người dùng sẽ không thể đăng nhập sau
                khi bị khóa. Email thông báo sẽ được gửi tự động cho người dùng.
              </p>
            </div>
          </div>
        ...
        <DialogContent className="bg-white border-gray-200 text-gray-900 max-w-md">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mt-4">
            <p className="text-sm text-green-800">
              <strong>Lưu ý:</strong> Người dùng sẽ có thể đăng nhập lại sau khi
              được mở khóa. Email thông báo sẽ được gửi tự động cho người dùng.
            </p>
          </div>
          <DialogFooter className="mt-6">
            <Button
