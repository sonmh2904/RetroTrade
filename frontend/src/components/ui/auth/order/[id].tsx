          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                ...
                {/* NÚT THANH TOÁN NGAY - HIỆN KHI CHƯA THANH TOÁN */}
                {["pending", "not_paid"].includes(order.paymentStatus) && (
                  <div className="mt-4">
                    <Link href={`/auth/payment/${order._id}`}>
                      <button className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-700 text-white font-bold py-4 rounded-xl shadow-lg transform transition-all duration-200 hover:scale-105 flex items-center justify-center gap-3 text-lg">
                    ...
                    <div className="mt-3 text-center">
                      <p className="text-xs text-red-600 font-medium animate-pulse">
                        Vui lòng thanh toán để chủ hàng xác nhận và giao hàng
                      </p>
                    </div>
                  </div>
                )}
